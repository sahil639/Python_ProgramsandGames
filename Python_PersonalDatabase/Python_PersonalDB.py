...
def add_command():
    Python_backend.insert(date_text.get(),earnings_text.get(),excercise_text.get(),study_text.get(),diet_text.get(),python_text.get())
    list.delete(0, END)
    list.insert(END, (date_text.get(),earnings_text.get(),excercise_text.get(),study_text.get(),diet_text.get(),python_text.get()))

def delete_command():
    Python_backend.delete(selected_row[0])
...
e4 = Entry(win, textvariable=excercise_text)
