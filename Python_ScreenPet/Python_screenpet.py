...
def toggle_tongue():
    if not c.tongue_out:
        ...
        c.itemconfigure(tongue_mains, state=NORMAL)
        c.tongue_out = True
    else:
        c.itemconfigure(tongue_tip, state=HIDDEN)
        c.itemconfigure(tongue_mains, state=HIDDEN)
        c.tongue_out = False
...
tongue_mains = c.create_rectangle(170,250,230,290,outline='red', fill='red', state=HIDDEN)
