...
tupil_let = c.create_oval(140,145,150,155,outline='black', fill='black')
eye_rigth = c.create_oval(230,110,260,170, outline='black', fill='white')
...
tongue_mains = c.create_rectangle(170,250,230,290,outline='red', fill='red')
